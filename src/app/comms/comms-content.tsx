    ...
    <PageTransition>
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-xs text-white/30 mt-0.5">{clients?.length ?? "..."} clients · CRM & channels</p>
        </div>
        ...
        <div className="space-y-6">
          {!clients ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
              {[1,2,3,4,5,6].map(i => (
                <Card key={i} className="p-4 animate-pulse"><div className="h-32 bg-white/[0.04] rounded" /></Card>
              ))}
            </div>
          ) : (
                        ...
                        <Card className={`p-4 border ${stage.bg}`}>
                          ...
                          <div className="mb-2">
                            ...
                            <select
                              ...
                              className="w-full text-[10px] rounded-lg bg-white/[0.04] border border-white/[0.08] px-2 py-1 text-white/60 focus:outline-none focus:ring-1 focus:ring-white/20"
                            >
                          ...
                          <div className="flex items-center gap-2 mt-2 pt-2 border-t border-white/[0.04]">
                            ...
                            <div className="flex items-center gap-1">
                              ...
                              <button
                                onClick={() => { if (confirm(`Delete ${c.name}?`)) deleteClient({ id: c._id }); }}
